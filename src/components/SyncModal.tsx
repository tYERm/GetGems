      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="relative w-20 h-20 mb-5 flex items-center justify-center">
              {[0, 1, 2].map(i => (
                <div key={i} className="absolute inset-0 rounded-full"
                  style={{
                    border: '1.5px solid rgba(35,130,255,0.35)',
            ...
            <h2 className="text-[20px] font-bold text-white mb-2 text-center font-display">
            ...
            <button
              onClick={handleSync}
              className="w-full text-white font-bold py-3.5 rounded-2xl active:scale-[0.97] transition-transform mb-3 flex items-center justify-center gap-2 text-[15px]"
            ...
            <button
              onClick={handleLater}
              className="w-full font-semibold py-3 rounded-xl active:scale-[0.97] transition-transform text-gray-400 text-[14px]"
