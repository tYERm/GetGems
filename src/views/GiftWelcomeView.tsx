...
export default function GiftWelcomeView() {
  ...
  return (
    <div className="fixed inset-0 bg-[#0e0e0f] z-[9999] flex flex-col items-center justify-center overflow-hidden">
      {/* Ambient glow behind the NFT card */}
      <div
      ...
      <div className="w-full max-w-sm flex flex-col items-center px-6 relative">
        ...
        >
          ...
          <span className="text-sm font-semibold text-[#8774e1]">
            Вам подарили NFT подарок!
          </span>
        </motion.div>
        ...
        >
          ...
          {giftNum && (
            <p className="text-base text-gray-400 font-medium mt-1">#{giftNum}</p>
          )}
        </motion.div>
        ...
        >
          Уникальный цифровой подарок ждёт вас.{'\n'}
          Авторизуйтесь, чтобы добавить его в коллекцию.
        </motion.p>
        ...
        <motion.button
          ...
          onClick={handleClaim}
          className="w-full bg-gradient-to-r from-[#8774e1] to-[#6c5fc7] text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-2 active:scale-[0.97] transition-transform shadow-lg shadow-[#8774e1]/30 mb-3"
        >
